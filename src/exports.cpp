...
static const char OUTPUT_MESSAGE_DEF[] =
	"void\0const char*\0message\0"
...
static const char GET_VERSION_DEF[] =
	"void\0char*,int\0versionOut,versionOut_sz\0"
...
void registerExports(reaper_plugin_info_t* rec) {
	...
	rec->Register(
		"APIvararg_osara_outputMessage", (void*)_vararg_osara_outputMessage
	);
	rec->Register("APIdef_osara_outputMessage", (void*)OUTPUT_MESSAGE_DEF);
	rec->Register(
		"API_osara_isShortcutHelpEnabled", (void*)osara_isShortcutHelpEnabled
	);
	rec->Register("API_osara_outputMessage", (void*)osara_outputMessage);
	rec->Register("APIvararg_osara_getVersion", (void*)_vararg_osara_getVersion);
